function sol_qpos = PAC_qpoms_CR3BP_matrix(z0,zpo,s0,vp0,phi0,p,pacqp)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[~,vp0] = F_qpoms_CR3BP_matrix(z0,zpo,vp0,p);
[~,vp0] = DF_qpoms_matrix(z0,vp0,p,zpo);
...
ps = PAC_correction_qpo_CR3BP_matrix(ps,vp0,zpo,pacqp,p);
disp("corrected")
...
for i=2:pacqp("n")
    ...
    % correct solution
    ps = PAC_correction_qpo_CR3BP_matrix(ps,ps{2,2},zpo,pacqp,p);
